...
TASK = TaskSpec(
    suite="libero_90",
    name="L90L1_pick_up_the_tomato_sauce_and_put_it_in_the_basket",
    source_class="L90L1PickUpTheTomatoSauceAndPutItInTheBasket",
    language="Pick up the tomato sauce and put it in the basket.",
    objects=(alphabet_soup, basket, cream_cheese, tomato_sauce, ketchup_bottle),
    goal=object_goal(tomato_sauce, basket, region="inside"),
)
