...
TASK = TaskSpec(
    source_class="LGOpenTheMiddleDrawerOfTheCabinet",
    suite="libero_goal",
    name="LG_open_the_middle_drawer_of_the_cabinet",
    ...
    goal=replace(joint_goal("cabinet", "open", 2), joint_min=0.137777136, release_distance=0.4),
)
