...
TASK = TaskSpec(
    suite="libero_10",
    name="L10L2_put_both_the_alphabet_soup_and_the_tomato_sauce_in_the_basket",
    source_class="L10L2PutBothTheAlphabetSoupAndTheTomatoSauceInTheBasket",
    language="Pick up the alphabet soup and the tomato sauce, and put them in the basket.",
    objects=(
        alphabet_soup,
        basket,
        butter,
    ...
    goals=(
        replace(
            object_goal(tomato_sauce, basket, region="inside"),
            release_distance=0.25,
            min_upright_cos=0.0,
        ),
    ),
