...
TASK = TaskSpec(
    source_class="LGPutTheCreamCheeseInTheBowl",
    suite="libero_goal",
    name="LG_put_the_cream_cheese_in_the_bowl",
    language="Pick up the cream cheese and put it in the bowl.",
    objects=(_PLATE, _BOWL, _BOTTLE, _CHEESE, _RACK),
    fixtures=(cabinet(), replace(stove(), position=(3.03, -2.34, 0.782))),
    goal=replace(object_goal(_CHEESE, _BOWL, region="inside"), min_upright_cos=0.0),
)
