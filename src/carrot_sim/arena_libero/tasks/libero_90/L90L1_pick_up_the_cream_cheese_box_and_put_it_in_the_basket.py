...
TASK = TaskSpec(
    suite="libero_90",
    name="L90L1_pick_up_the_cream_cheese_box_and_put_it_in_the_basket",
    source_class="L90L1PickUpTheCreamCheeseBoxAndPutItInTheBasket",
    ...
    goal=object_goal(cream_cheese, basket, region="inside"),
)
