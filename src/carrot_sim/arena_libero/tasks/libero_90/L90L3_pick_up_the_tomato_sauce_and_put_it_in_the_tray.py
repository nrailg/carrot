...
TASK = TaskSpec(
    suite="libero_90",
    name="L90L3_pick_up_the_tomato_sauce_and_put_it_in_the_tray",
    source_class="L90L3PickUpTheTomatoSauceAndPutItInTheTray",
    ...
    goal=object_goal(tomato_sauce, wooden_tray, region="inside"),
)
