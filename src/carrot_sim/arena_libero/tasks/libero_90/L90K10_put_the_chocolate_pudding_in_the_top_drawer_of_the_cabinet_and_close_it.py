...
chocolate_pudding = table_object("chocolate_pudding", "chocolate_pudding", (2.17, -2.18), scale=0.7)

TASK = TaskSpec(
    suite="libero_90",
    name="L90K10_put_the_chocolate_pudding_in_the_top_drawer_of_the_cabinet_and_close_it",
    source_class="L90K10PutTheChocolatePuddingInTheTopDrawerOfTheCabinetAndCloseIt",
    ...
    goal=drawer_goal(chocolate_pudding, 1, closed=True),
)
