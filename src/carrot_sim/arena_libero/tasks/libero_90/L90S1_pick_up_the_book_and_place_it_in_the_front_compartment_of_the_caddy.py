...
TASK = TaskSpec(
    suite="libero_90",
    name="L90S1_pick_up_the_book_and_place_it_in_the_front_compartment_of_the_caddy",
    source_class="L90S1PickUpTheBookAndPlaceItInTheFrontCompartmentOfTheCaddy",
