...
TASK = TaskSpec(
    suite="libero_90",
    name="L90S3_pick_up_the_book_and_place_it_in_the_left_compartment_of_the_caddy",
    source_class="L90S3PickUpTheBookAndPlaceItInTheLeftCompartmentOfTheCaddy",
    language="Pick up the book and place it in the left compartment of the caddy.",
    objects=(black_book, desk_caddy, red_coffee_mug),
    goal=object_goal(black_book, desk_caddy, region="left"),
)
