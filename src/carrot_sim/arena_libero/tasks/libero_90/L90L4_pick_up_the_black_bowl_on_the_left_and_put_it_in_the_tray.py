...
TASK = TaskSpec(
    suite="libero_90",
    name="L90L4_pick_up_the_black_bowl_on_the_left_and_put_it_in_the_tray",
    source_class="L90L4PickUpTheBlackBowlOnTheLeftAndPutItInTheTray",
    ...
    goal=object_goal(akita_black_bowl, wooden_tray, region="inside"),
)
