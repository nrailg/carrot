...
TASK = TaskSpec(
    source_class="LGPutTheWineBottleOnTopOfTheCabinet",
    suite="libero_goal",
    name="LG_put_the_wine_bottle_on_top_of_the_cabinet",
    ...
    goal=replace(fixture_goal(_BOTTLE, "cabinet"), half_size=(0.055, 0.055, 0.30)),
)
