...
TASK = TaskSpec(
    suite="libero_90",
    name="L90S1_pick_up_the_book_and_place_it_in_the_right_compartment_of_the_caddy",
    source_class="L90S1PickUpTheBookAndPlaceItInTheRightCompartmentOfTheCaddy",
    language="Pick up the book and place it in the right compartment of the caddy.",
    objects=(desk_caddy, book, mug),
    goal=object_goal(book, desk_caddy, region="right"),
)
