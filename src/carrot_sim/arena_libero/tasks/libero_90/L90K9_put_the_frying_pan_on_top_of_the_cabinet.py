...
TASK = TaskSpec(
    suite="libero_90",
    name="L90K9_put_the_frying_pan_on_top_of_the_cabinet",
    source_class="L90K9PutTheFryingPanOnTopOfTheCabinet",
    language="Put the frying pan on top of the cabinet.",
    objects=(shelf, bowl, frying_pan),
    fixtures=(stove(),),
    goal=object_goal(frying_pan, shelf),
)
