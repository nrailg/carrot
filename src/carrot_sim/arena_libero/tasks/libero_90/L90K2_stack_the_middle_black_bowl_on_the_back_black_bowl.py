...
TASK = TaskSpec(
    suite="libero_90",
    name="L90K2_stack_the_middle_black_bowl_on_the_back_black_bowl",
    source_class="L90K2StackTheMiddleBlackBowlOnTheBackBlackBowl",
    language="Stack the middle black bowl on the back black bowl.",
    objects=(akita_black_bowl_back, plate, akita_black_bowl_middle, akita_black_bowl_front),
    fixtures=(cabinet(),),
    goal=object_goal(akita_black_bowl_middle, akita_black_bowl_back),
)
