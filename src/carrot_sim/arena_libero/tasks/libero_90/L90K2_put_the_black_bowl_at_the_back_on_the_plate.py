...
TASK = TaskSpec(
    suite="libero_90",
    name="L90K2_put_the_black_bowl_at_the_back_on_the_plate",
    source_class="L90K2PutTheBlackBowlAtTheBackOnThePlate",
    ...
    fixtures=(cabinet(),),
    goal=object_goal(akita_black_bowl_back, plate),
)
